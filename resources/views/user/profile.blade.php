        ...
        <div class="col-md-6">
            ...
            <div class="card p-2  rounded-0 mt-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <a href="{{ url('question/edit_question/' . $item->id) }}" class="text-decoration-none">Edit</a>
                        <a href="{{ url('question/delete/' . $item->id) }}" class="text-danger text-decoration-none">Hapus</a>
                    </div>
                </div>
            </div>
            @endforeach
